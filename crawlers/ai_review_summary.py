...
각 카테고리는 "title"(6~12자 내외의 짧은 명사구)과 "desc"(리뷰 내용에 실제로 근거한 간결한 설명)로 구성합니다.
desc는 반드시 "~음/~함/~됨" 등 개조식 어미로 끝내고, "~습니다/~해요/~됩니다" 같은 완전한 문장체나 불필요한
조사·수식어는 쓰지 마세요. 예: "물 없이도 편리하게 먹을 수 있습니다" (X) → "물 없이도 편리하게 섭취 가능" (O).
